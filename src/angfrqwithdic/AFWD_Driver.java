...
public class AFWD_Driver {
	...
	public static void main(String[] args) throws URISyntaxException {
		...
		JobConf conf = new JobConf(angfrqwithdic.AFWD_Driver.class);
		...
		conf.setMapperClass(angfrqwithdic.AFWD_Mapper.class);
		conf.setCombinerClass(angfrqwithdic.AFWD_Reducer.class);
		conf.setReducerClass(angfrqwithdic.AFWD_Reducer.class);
